...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Requisição de Material</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
        <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            <div class="row">
                <div class="col-sm-6">
                        ...
                        <form method="get" action="{{ action('RequisicaoMaterialController@pesquisarPorCriterio') }}">
                          <select class="form-control input-sm" name="criterio">
                            <option value="id">ID</option>
                            <option value="descricao">Data Emissão</option>
                    ...
                    <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 362.1px;" aria-label="Browser: activate to sort column ascending">Data Emissão</th>
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 322.167px;" aria-label="Platform(s): activate to sort column ascending">Status</th>

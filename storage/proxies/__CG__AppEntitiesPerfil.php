 ...
 */
class Perfil extends \App\Entities\Perfil implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Perfil' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Perfil' . "\0" . 'descricao'];
        }

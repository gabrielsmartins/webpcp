...
class Usuario extends \App\Entities\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Usuario' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Usuario' . "\0" . 'nome', '' . "\0" . 'App\\Entities\\Usuario' . "\0" . 'login', '' . "\0" . 'App\\Entities\\Usuario' . "\0" . 'senha', '' . "\0" . 'App\\Entities\\Usuario' . "\0" . 'perfil'];
        }

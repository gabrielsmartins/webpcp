 ...
 */
class Material extends \App\Entities\Material implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'codigoInterno', 'descricao', 'situacao', 'unidadeMedida', 'valorUnitario', 'leadTime', 'quantidadeEstoque', 'quantidadeMinima', 'peso', 'comprimento', 'largura', 'altura'];
        }
